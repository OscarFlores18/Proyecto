...
function eliminarRodado(data){
    ...
    Swal.fire({
        title: "Esta seguro de Eliminar el rodado?",
        text: "El rodado asera eliminado de la base!",
        icon: "warning",
        ...
        if (result.isConfirmed) {
            ...
            $.ajax({
                type: "get",
                url: contextPath+"/EliminarRodado?id="+value,
                dataType: "json",
                success: function (response) {
                    //agregamos sweet alert
                    Swal.fire({
                        title: "Eliminado!",
                        text: "El rodado se elimino correctamente.",
                        icon: "success",
